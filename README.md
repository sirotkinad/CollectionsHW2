...
TreeSet будет полезен в случаях, когда элементы должны быть упорядочены в соответствии с каким-либо правилом. Также в TreeSet нельзя хранить null элементы.  HashSet можно использовать, когда не принципиально поддерживать порядок элементов. 
